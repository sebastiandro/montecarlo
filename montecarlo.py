...
class Montecarlo():
    ...
    # Find the hand with highest score from a list of hands
    def find_winning_hand(self, hands):
        scores = [(i, self.calculate_hand_score(hand))
    ...
    def calculate_hand_score(self, hand):
        ...
        potential_pair = score[0] == (2, 1, 1, 1, 1)
...
sc = mc.calculate_hand_score(['2H', '3H', '4H', '5S', '6H', '7D', 'KC'])
